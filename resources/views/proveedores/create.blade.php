...
<body class="flex items-center justify-center min-h-screen">
    <div class="container mx-auto px-4 py-8 max-w-2xl bg-white shadow-xl rounded-2xl">
        <div class="mb-6 text-center">
            <h1 class="text-3xl font-bold text-gray-800">Crear Nuevo Proveedor</h1>
            <p class="text-gray-500 mt-2">
                Completa el formulario para añadir un nuevo proveedor a tu base de datos.
            </p>
        </div>
        ...
        <div class="bg-gray-100 p-6 rounded-xl shadow-inner mb-8">
            <form action="{{ route('proveedores.store') }}" method="POST">
                ...
                <div class="mt-6 flex justify-end space-x-2">
                    <a href="{{ route('proveedores.index') }}" class="bg-gray-400 hover:bg-gray-500 text-white font-semibold py-2 px-6 rounded-lg shadow-md transition-colors">Volver</a>
